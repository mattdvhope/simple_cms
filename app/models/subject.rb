class Subject < ActiveRecord::Base
  ...
  # has_many :pages, :dependent => :destroy <-- This deletes everything in the tree below it. The ':dependent => :destroy' option adds the callback 'after_destroy' to the 'has_many' relationship.
  has_many :pages
